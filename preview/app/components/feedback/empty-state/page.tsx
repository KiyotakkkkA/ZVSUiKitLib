    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "EmptyState overview",
                    navTitle: "Overview",
                }}
            >
            ...
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "EmptyState example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="EmptyStateExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
