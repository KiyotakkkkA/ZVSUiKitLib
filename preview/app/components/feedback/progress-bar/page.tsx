...
export const metadata: Metadata = {
    title: "ProgressBar",
    description: "Progress indicator with optional label.",
};
    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "ProgressBar overview",
                    navTitle: "Overview",
                }}
            >
            ...
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "ProgressBar example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="ProgressBarExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
