    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "InputSlider overview",
                    navTitle: "Overview",
                }}
            >
            ...
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "InputSlider example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="InputSliderExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
