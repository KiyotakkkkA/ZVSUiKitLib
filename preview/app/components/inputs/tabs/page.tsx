...
export const metadata: Metadata = {
    title: "Tabs",
    description: "Line-style tab switcher.",
};
    ...
    return (
        <DocumentationPage>
            ...
            >
                ...
                <SectionPreview.Code label="TabsExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
                nav={{ id: "api", headerTitle: "Tabs API", navTitle: "API" }}
            >
                <SectionAPI.Group
