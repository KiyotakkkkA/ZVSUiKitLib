...
export const metadata: Metadata = {
    title: "InputRange",
    description: "Numeric boundary range selector.",
};
    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "InputRange overview",
                    navTitle: "Overview",
                }}
            >
                ...
                <SectionOverview.Description>
                    Numeric boundary range selector.
                </SectionOverview.Description>
            </SectionOverview>
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "InputRange example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="InputRangeExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
