...
export const metadata: Metadata = {
    title: "Calendar",
    description: "Configurable date calendar.",
};
        ...
        <DocumentationPage>
            <SectionOverview nav={{ id: "overview", title: "Overview" }}>
                ...
                <SectionOverview.Description>
                    Date selection with constraints, localization, controlled
                    view state, and custom day rendering.
                </SectionOverview.Description>
            </SectionOverview>
