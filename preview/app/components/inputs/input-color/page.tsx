    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "InputColor overview",
                    navTitle: "Overview",
                }}
            >
            ...
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "InputColor example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="InputColorExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
