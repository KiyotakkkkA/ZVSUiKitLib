    ...
    "root": {
        ...
        "props": {
            ...
            "onChange": {
                ...
                "description": "Called with #RRGGBB, or #RRGGBBAA when translucent."
            },
            "label": {
                "type": "ReactNode",
            ...
            "showValue": {
                "type": "boolean",
                "description": "Shows the current formatted color in the trigger.",
                "defaultValue": "true"
            },
            "size": {
                "type": "InputColorSize",
            ...
            "disabled": {
                "type": "boolean",
                "description": "Disables the trigger and all picker interactions.",
                "defaultValue": "false"
            },
            "readOnly": {
                "type": "boolean",
