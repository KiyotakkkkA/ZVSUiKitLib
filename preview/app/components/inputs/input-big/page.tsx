    ...
    return (
        <DocumentationPage>
            ...
            >
                ...
                <SectionPreview.Code label="InputBigExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
