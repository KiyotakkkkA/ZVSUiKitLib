    ...
    InputCheckBox: [
        {
            ...
            props: [
                ...
                p("children", "ReactNode", "Clickable label content."),
                p("className", "string", "Outer label classes."),
                c("InputCheckBoxClassNames", [
                    "input",
                    "control",
                    "content",
                    "mark",
    ...
    InputSmall: [
        {
            ...
            props: [
                ...
                p(
                    ...
                    "Explicit native type; overrides non-password preset types.",
                ),
                p(
                    "preset",
                    '"password" | "search" | "email" | "phone" | "url"',
                    "Coordinated type, input mode, autocomplete, icon, and interaction preset.",
                ),
                p(
                    "onClear",
                    "() => void",
                    "Called when the search preset is cleared.",
                ),
                p(
                    "value / defaultValue",
                    "string | number",
