...
export const metadata: Metadata = {
    ...
    description: "Radios connected to an exclusive boolean model.",
};
    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "InputRadioGroup overview",
                    navTitle: "Overview",
                }}
            >
                ...
                <SectionOverview.Description>
                    Coordinate an exclusive radio selection through one
                    immutable boolean model.
                </SectionOverview.Description>
            </SectionOverview>
            <SectionPreview
                nav={{
                    id: "controlled-group",
                    headerTitle: "Controlled radio group",
                    navTitle: "Group",
                }}
            >
                ...
                <SectionPreview.Code label="InputRadioGroupExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
                nav={{
                    id: "api",
                    headerTitle: "InputRadioGroup API",
                    navTitle: "API",
                }}
            >
                <SectionAPI.Group
