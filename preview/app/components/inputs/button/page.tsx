...
export const metadata: Metadata = {
    title: "Button",
    description: "Base button with variants and shape options.",
};
        ...
        <DocumentationPage>
            ...
            >
                ...
                <SectionOverview.Description>
                    Base button with variants and shape options.
                </SectionOverview.Description>
            </SectionOverview>
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "Button example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="ButtonExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
                nav={{ id: "api", headerTitle: "Button API", navTitle: "API" }}
            >
                <SectionAPI.Group
