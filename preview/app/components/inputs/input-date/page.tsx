    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "InputDate overview",
                    navTitle: "Overview",
                }}
            >
            ...
            >
                ...
                <SectionPreview.Code label="InputDateExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
