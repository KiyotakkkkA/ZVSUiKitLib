...
export const metadata: Metadata = {
    title: "Select",
    description: "Searchable single-value select.",
};
    ...
    return (
        <DocumentationPage>
            ...
            >
                ...
                <SectionPreview.Code label="SelectExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
                nav={{ id: "api", headerTitle: "Select API", navTitle: "API" }}
            >
                <SectionAPI.Group
