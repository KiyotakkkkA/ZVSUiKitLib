...
export const metadata: Metadata = {
    title: "InputPins",
    description: "Segmented PIN and OTP input.",
};
    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "InputPins overview",
                    navTitle: "Overview",
                }}
            >
                ...
                <SectionOverview.Description>
                    Segmented PIN and OTP input.
                </SectionOverview.Description>
            </SectionOverview>
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "InputPins example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="InputPinsExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
