...
export const metadata: Metadata = {
    title: "Blockquote",
    description: "Block quotation with an optional source or attribution.",
};
        ...
        <DocumentationPage>
            ...
            <SectionPreview
                nav={{
                    id: "preview",
                    navTitle: "Preview",
                    headerTitle: "Blockquote example",
                }}
            ...
            >
                ...
                <SectionPreview.Code label="BlockquoteExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
