...
export const metadata: Metadata = {
    title: "Chart",
    description: "Line, area, and bar data chart.",
};
        ...
        <DocumentationPage>
            ...
            >
                ...
                <SectionOverview.Description>
                    Line, area, and bar data chart.
                </SectionOverview.Description>
            </SectionOverview>
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "Chart example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="ChartExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
                nav={{ id: "api", headerTitle: "Chart API", navTitle: "API" }}
            >
                <SectionAPI.Group
