    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "Separator overview",
                    navTitle: "Overview",
                }}
            >
            ...
            >
                ...
                <SectionPreview.Code label="SeparatorExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
