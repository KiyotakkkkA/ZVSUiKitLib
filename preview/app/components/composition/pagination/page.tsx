...
export const metadata: Metadata = {
    title: "Pagination",
    description: "Pagination and page-size controls.",
};
    ...
    return (
        <DocumentationPage>
            <SectionOverview
                nav={{
                    id: "overview",
                    headerTitle: "Pagination overview",
                    navTitle: "Overview",
                }}
            >
            ...
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "Pagination example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="PaginationExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
