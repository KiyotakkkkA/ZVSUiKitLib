    ...
    return (
        <DocumentationPage>
            ...
            >
                ...
                <SectionPreview.Code label="CardExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
                nav={{ id: "api", headerTitle: "Card API", navTitle: "API" }}
            >
                <SectionAPI.Group
