...
export const metadata: Metadata = {
    title: "TreeView",
    description: "Hierarchical optionally virtualized list.",
};
        ...
        <DocumentationPage>
            ...
            >
                ...
                <SectionOverview.Description>
                    Hierarchical optionally virtualized list.
                </SectionOverview.Description>
            </SectionOverview>
            <SectionPreview
                nav={{
                    id: "basic-example",
                    headerTitle: "TreeView example",
                    navTitle: "Example",
                }}
            >
                ...
                <SectionPreview.Code label="TreeViewExample.tsx">
                    {usage}
                </SectionPreview.Code>
            </SectionPreview>
            <SectionAPI
