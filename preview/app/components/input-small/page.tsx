                ...
                >
                    <SectionAPI.Table>
                        <SectionAPI.Prop
                            name="className"
                            type="string"
                            description="Classes applied to the native input."
                        />
                        <SectionAPI.Prop
                            name="classNames"
                        ...
                        >
                            ...
                            >
                                ...
                                <SectionAPI.Prop
                                    name="icon"
                                    type="string"
                                    description="Password visibility icon classes."
                                />
                            </SectionAPI.Object>
                        </SectionAPI.Prop>
                        <SectionAPI.Prop
                            ...
                            defaultValue="text"
                            description="Password enables the visibility toggle."
                        />
                        <SectionAPI.Prop
                        ...
                        <SectionAPI.Prop
                            ...
                            type="boolean"
                            defaultValue="false"
                            description="Disables input and interaction."
                        />
                        <SectionAPI.Prop
                            name="readOnly"
                            type="boolean"
                            defaultValue="false"
                            description="Prevents value edits without disabling focus."
                        />
                        <SectionAPI.Prop
                            name="name / id"
                            type="string"
                            description="Native form and label identifiers."
                        />
                        <SectionAPI.Prop
                            name="autoComplete"
                        ...
                        <SectionAPI.Prop
                            ...
                            description="All remaining native input attributes are forwarded."
                        />
                    </SectionAPI.Table>
                </SectionAPI.Group>
            </SectionAPI>
