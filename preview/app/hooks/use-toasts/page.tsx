        ...
        <DocumentationPage>
            ...
            >
                ...
                <SectionOverview.Description>
                    Push accessible, timed notifications from anywhere inside
                    ToastProvider.
                </SectionOverview.Description>
                ...
                >
                    <SectionAPI.Table>
                        ...
                        <SectionAPI.Prop
                            name="danger"
                            type="(input: ToastInput) => void"
                            description="Error or destructive notification."
                        />
                        <SectionAPI.Prop
                            name="push"
                            type="(type: ToastType, input: ToastInput) => void"
                            description="Dynamic toast variant."
                        />
                    </SectionAPI.Table>
                </SectionAPI.Group>
                <SectionAPI.Group title="ToastInput">
                    <SectionAPI.Table>
                        ...
                        <SectionAPI.Prop
                            ...
                            type="number"
                            defaultValue="3500"
                            description="Visible duration, clamped to 1200–20000 ms."
                        />
                    </SectionAPI.Table>
                </SectionAPI.Group>
            </SectionAPI>
