...
type ChartProps = Omit<ComponentPropsWithoutRef<"div">, "children"> & {
    data: ChartDataItem[];
    series: ChartSeries[];
    xKey: string;
...
type DefaultTooltipProps = ChartTooltipProps & {
    classNames?: ChartClassNames;
};
...
export type { ChartProps, ChartSeries, ChartDataItem, ChartType };
