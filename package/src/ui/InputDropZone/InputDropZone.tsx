        ...
        <div ref={ref} className={"space-y-3"}>
            ...
            >
                {hasSelection && !multiple && selectedItems[0].previewSrc ? (
                    <span
                        className={
                            "grid w-full gap-3 sm:grid-cols-[120px_minmax(0,1fr)] sm:items-center"
                        }
                    >
                        <span
                            className={
                                "h-28 overflow-hidden rounded-md border border-main-700/80"
                            }
                        >
                            <img
                        ...
                        <span className={"min-w-0"}>
                            <span
                                className={
                                    "block truncate text-sm font-semibold text-main-50"
                                }
                            >
                            ...
                            <span
                                className={
                                    "mt-1 block text-sm leading-6 text-main-400"
                                }
                            >
                    ...
                    >
                        <span
                            className={
                                "flex h-12 w-12 items-center justify-center rounded-md bg-main-700/65 text-[26px] text-main-100"
                            }
                        >
                        ...
                        <span
                            className={
                                "mt-3 max-w-full truncate text-sm font-semibold text-main-100"
                            }
                        >
                            {selectedItems[0].name}
                        </span>
                    ...
                    >
                        ...
                        <span
                            className={
                                "mt-3 text-sm font-semibold text-main-100"
                            }
                        >
                ...
                <div className={"grid gap-2"}>
                    {selectedItems.map((item) => (
                        <div
                            key={item.id}
                            className={
                                "flex items-center gap-3 rounded-md border border-main-700 bg-main-800/40 p-2"
                            }
                        >
                            {item.previewSrc ? (
                                <span
                                    className={
                                        "h-12 w-12 overflow-hidden rounded border border-main-700"
                                    }
                                >
                                    <img
                                        src={item.previewSrc}
                                ...
                                <span
                                    className={
                                        "flex h-12 w-12 shrink-0 items-center justify-center rounded border border-main-700 text-[22px] text-main-300"
                                    }
                                >
                                    {item.icon}
                                </span>
                            ...
                            <span
                                className={
                                    "min-w-0 flex-1 truncate text-sm font-semibold text-main-100"
                                }
                            >
                                {item.name}
                            </span>
                            <button
                                ...
                                className={
                                    "text-sm font-semibold text-danger-light transition hover:text-danger-medium disabled:cursor-not-allowed disabled:opacity-60"
                                }
                            >
                                {t.removeLabel}
                            </button>
