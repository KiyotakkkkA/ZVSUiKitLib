...
export const InputColor = forwardRef<HTMLInputElement, InputColorProps>(
    function InputColor(
        ...
        return (
            <div className={cn("flex w-full flex-col gap-2", disabled && "opacity-60", className)}>
                {label && (
                    <label
                        htmlFor={triggerId}
                        className={cn(
                ...
                >
                    ...
                    <Dropdown.Menu
                        className={cn("rounded-2xl border border-main-700 bg-main-900 p-3 shadow-2xl", classNames?.panel)}
                    >
                        <div className={"mb-3 flex items-center gap-2.5"}>
                            ...
                            <div className={"min-w-0"}>
                                <p className={"text-sm font-medium text-main-100"}>{t.title}</p>
                                <p className={"font-mono text-xs text-main-400"}>{currentValue}</p>
                            </div>
                        </div>
                        ...
                        {palettePresets && palettePresets.length > 0 && (
                            <div
                                className={cn("mt-3 border-t border-main-700/70 pt-3", classNames?.palette)}
                            >
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    isSelected && "ring-2 ring-main-100 ring-offset-2 ring-offset-main-900",
                                                    classNames?.preset,
                                                )}
                                                style={{
